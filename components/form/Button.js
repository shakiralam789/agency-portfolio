...
export const Button = ({
  ...
  const variantClasses = {
    primary:
      "bg-primary-dark text-white hover:bg-black focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2",
    danger:
    ...
    "stroke-icon":
      "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-gray-500/50 focus:ring-offset-2",
    edit: "bg-white border border-gray-300 text-primary-dark hover:bg-gray-50 focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2",
  };
...
export const IconButton = ({
  ...
  const variantClasses = {
    primary:
      "bg-primary-dark text-white hover:bg-purple-700 focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2",
    danger:
      "bg-red-500 text-white hover:bg-red-600 focus:ring-2 focus:ring-red-500 focus:ring-offset-2",
    stroke:
      "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-gray-500/50 focus:ring-offset-2",
